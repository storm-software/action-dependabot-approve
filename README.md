...
A composite action used by Storm Software repositories to automate the approval of Dependabot pull requests.
...
the root repo directory (/action-dependabot-approve).
